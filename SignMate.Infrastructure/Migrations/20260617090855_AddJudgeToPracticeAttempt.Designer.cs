...
namespace SignMate.Infrastructure.Migrations
{
    ...
    [Migration("20260617090855_AddJudgeToPracticeAttempt")]
    partial class AddJudgeToPracticeAttempt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignMate.Domain.Entities.PracticeAttempt", b =>
                {
                    ...
                    b.Property<string>("JudgeRubricJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SignMate.Domain.Entities.SignReferenceRequest", b =>
                {
                    ...
                    b.Property<string>("ExtractedKeypoints")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("SignReferenceRequests");
                });
            ...
            modelBuilder.Entity("SignMate.Domain.Entities.SignReferenceRequest", b =>
                {
                    b.HasOne("SignMate.Domain.Entities.User", "ReviewedBy")
                        .WithMany()
                    ...
                    b.HasOne("SignMate.Domain.Entities.User", "Uploader")
                        .WithMany()
